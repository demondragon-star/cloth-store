...
// Convert to animated component for press effects
...
export const ProductCard: React.FC<ProductCardProps> = ({
    ...
    const entryAnimation = FadeInDown.delay(index * 100).springify().damping(14).stiffness(120);
    ...
    if (variant === 'horizontal') {
        return (
            ...
            >
                ...
                {onWishlistPress && (
                    <TouchableOpacity onPress={onWishlistPress} style={styles.horizontalWishlistButton} hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
                        <Ionicons
    ...
    return (
        ...
        >
            <View style={styles.imageContainer}>
                ...
                {/* Wishlist Button */}
                {onWishlistPress && (
                    <TouchableOpacity onPress={onWishlistPress} style={styles.wishlistButton} hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
