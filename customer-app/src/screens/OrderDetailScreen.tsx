...
export const OrderDetailScreen: React.FC = () => {
    ...
    const confirmCancel = async (reason: string) => {
        ...
        try {
            const { error } = await orderService.cancelOrder(order.id, reason);
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <Card style={styles.statusCard}>
                    ...
                    {/* Tracking Card (shown whenever tracking_url is available) */}
                    {order.tracking_url && (
                        <View style={styles.trackingCard}>
                            <View style={styles.trackingCardHeader}>
                                <Ionicons name="location" size={18} color={COLORS.primary} />
                                <Text style={styles.trackingCardTitle}>Parcel Tracking</Text>
                                {order.courier_name && (
                                    <Text style={styles.trackingCourier}>{order.courier_name}</Text>
                                )}
                            </View>
                            <TouchableOpacity style={styles.trackingButton} onPress={handleTrackOrder}>
                                <Ionicons name="locate-outline" size={20} color={COLORS.primary} />
                                <Text style={styles.trackingText}>Track Parcel</Text>
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContainer}>
                        ...
                        {CANCEL_REASONS.map((reason) => (
                            ...
                            >
                                <Ionicons name="radio-button-off-outline" size={20} color={COLORS.primary} />
